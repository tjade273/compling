...
let dolgo_of_string s =
  let rec to_char c = match c with 
  ...
  |"₁₁"|"₂₂"|"¹¹"|"²²"|"₁₂"|"₁₃"|"₁₄"|"₁₅"|"₂₃"|"₂₄"|"₂₅"|"₃₄"|"₃₅"|"₄₅"|"¹²"|"¹³"|"¹⁴"|"¹⁵"|"²³"|"²⁴"|"²⁵"|"³⁵"|"³⁴"|"⁴⁵"|"₅₁"|"₅₂"|"₅₃"|"₅₄"|"₄₃"|"₄₂"|"₄₁"|"₃₂"|"₃₁"|
     "₂₁"|"⁵¹"|"⁵²"|"⁵³"|"⁵⁴"|"⁴¹"|"⁴²"|"⁴³"|"³¹"|"³²"|"²¹"|"₃₃"|"³³"|"₄₄"|"₅₅"|
       "⁵⁵"|"⁴⁴"|"⁰"|"¹"|"²"|"³"|"⁴"|"⁵"|"⁻"|"₁"|"₂"|"₃"|"₄"|"₅"|"₆"|"₀"|"˥"|
         "˦"|"˨"|"˧" -> '1'
  |"_"|"#"|"◦"|"·" -> '_'
  | x -> (*print_string ("Unknown character: "^x^"\n");*)
         match List.rev (String.explode x) with
         | [] -> 'V'
         | hd::[] -> 'V'
         | hd::tl -> to_char (String.implode (List.rev tl))
  in
  Token(to_char s,s)
